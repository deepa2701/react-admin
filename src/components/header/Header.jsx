        ...
        <div className="navbar-container d-flex content">
            ...
            <ul className="nav navbar-nav align-items-center ms-auto">
                ...
                {/* <li className="nav-item dropdown dropdown-cart me-25"><a className="nav-link" href="#" data-bs-toggle="dropdown"><i className="ficon" data-feather="shopping-cart"></i><span className="badge rounded-pill bg-primary badge-up cart-item-count">6</span></a>
                    <ul className="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li className="scrollable-container media-list">
                            <div className="list-item align-items-center"><img className="d-block rounded me-1" src="assets/images/pages/eCommerce/1.png" alt="donuts" width="62"/>
                            ...
                            <div className="list-item align-items-center"><img className="d-block rounded me-1" src="assets/images/pages/eCommerce/7.png" alt="donuts" width="62"/>
                                <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                    <div className="media-heading">
                                    ...
                                    <div className="cart-item-qty">
                                        <div className="input-group">
                                            <input className="touchspin-cart" type="number" value="3"/>
                                        </div>
                                    </div>
                                    <h5 className="cart-item-price">$129.40</h5>
                                </div>
                            </div>
                            <div className="list-item align-items-center"><img className="d-block rounded me-1" src="assets/images/pages/eCommerce/2.png" alt="donuts" width="62"/>
                                <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                    <div className="media-heading">
                                    ...
                                    <div className="cart-item-qty">
                                        <div className="input-group">
                                            <input className="touchspin-cart" type="number" value="2"/>
                                        </div>
                                    </div>
                                    <h5 className="cart-item-price">$699.00</h5>
                                </div>
                            </div>
                            <div className="list-item align-items-center"><img className="d-block rounded me-1" src="assets/images/pages/eCommerce/3.png" alt="donuts" width="62"/>
                                <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                    <div className="media-heading">
                            ...
                            <div className="list-item align-items-center"><img className="d-block rounded me-1" src="assets/images/pages/eCommerce/5.png" alt="donuts" width="62"/>
                                <div className="list-item-body flex-grow-1"><i className="ficon cart-item-remove" data-feather="x"></i>
                                    <div className="media-heading">
                    ...
                    <ul className="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li className="scrollable-container media-list"><a className="d-flex" href="#">
                                <div className="list-item d-flex align-items-start">
                                    <div className="me-1">
                                        <div className="avatar"><img src="assets/images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32" height="32"/></div>
                                    </div>
                                ...
                                <div className="list-item d-flex align-items-start">
                                    <div className="me-1">
                                        <div className="avatar"><img src="assets/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32"/></div>
                                    </div>
                                    <div className="list-item-body flex-grow-1">
                            ...
                            <div className="list-item d-flex align-items-center">
                                ...
                                <div className="form-check form-check-primary form-switch">
                                    <input className="form-check-input" id="systemNotification" type="checkbox" checked=""/>
                ...
                <li className="nav-item dropdown dropdown-user"><a className="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div className="user-nav d-sm-flex d-none"><span className="user-name fw-bolder">John Doe</span><span className="user-status">Admin</span></div><span className="avatar"><img className="round" src="assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"/><span className="avatar-status-online"></span></span>
                    </a>
    ...
    <ul className="main-search-list-defaultlist d-none">
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div className="d-flex">
                    <div className="me-75"><img src="assets/images/icons/xls.png" alt="png" height="32"/></div>
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div className="d-flex">
                    <div className="me-75"><img src="assets/images/icons/jpg.png" alt="png" height="32"/></div>
                    <div className="search-data">
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div className="d-flex">
                    <div className="me-75"><img src="assets/images/icons/pdf.png" alt="png" height="32"/></div>
                    <div className="search-data">
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div className="d-flex">
                    <div className="me-75"><img src="assets/images/icons/doc.png" alt="png" height="32"/></div>
                    <div className="search-data">
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                <div className="d-flex align-items-center">
                    <div className="avatar me-75"><img src="assets/images/portrait/small/avatar-s-8.jpg" alt="png" height="32"/></div>
                    <div className="search-data">
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                <div className="d-flex align-items-center">
                    <div className="avatar me-75"><img src="assets/images/portrait/small/avatar-s-1.jpg" alt="png" height="32"/></div>
                    <div className="search-data">
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                <div className="d-flex align-items-center">
                    <div className="avatar me-75"><img src="assets/images/portrait/small/avatar-s-14.jpg" alt="png" height="32"/></div>
                    <div className="search-data">
        ...
        <li className="auto-suggestion"><a className="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                <div className="d-flex align-items-center">
                    <div className="avatar me-75"><img src="assets/images/portrait/small/avatar-s-6.jpg" alt="png" height="32"/></div>
                    <div className="search-data">
