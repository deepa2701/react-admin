                        ...
                        <div className="col-xl-4 col-md-6 col-12">
                            <div className="card card-congratulation-medal">
                                <div className="card-body">
                                    ...
                                    <img src="assets/images/illustration/badge.svg" className="congratulation-medal" alt="Medal Pic" />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="card-body">
                                    <div className="browser-states">
                                        <div className="d-flex">
                                            <img src="assets/images/icons/google-chrome.png" className="rounded me-1" height="30" alt="Google Chrome" />
                                    ...
                                    <div className="browser-states">
                                        <div className="d-flex">
                                            <img src="assets/images/icons/mozila-firefox.png" className="rounded me-1" height="30" alt="Mozila Firefox" />
                                    ...
                                    <div className="browser-states">
                                        <div className="d-flex">
                                            <img src="assets/images/icons/apple-safari.png" className="rounded me-1" height="30" alt="Apple Safari" />
                                    ...
                                    <div className="browser-states">
                                        <div className="d-flex">
                                            <img src="assets/images/icons/internet-explorer.png" className="rounded me-1" height="30" alt="Internet Explorer" />
                                    ...
                                    <div className="browser-states">
                                        <div className="d-flex">
                                            <img src="assets/images/icons/opera.png" className="rounded me-1" height="30" alt="Opera Mini" />
