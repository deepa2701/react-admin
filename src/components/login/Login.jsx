                    ...
                    <div className="auth-inner my-2">
                        ...
                        <div className="card mb-0">
                            <div className="card-body">
                                ...
                                <form className="auth-login-form mt-2" onSubmit={submitClick} method="POST">
                                    <div className="mb-1">
                                        <label htmlFor="login-email" className="form-label">Email</label>
                                        <input onChange={(e) => setUsername(e.target.value)} type="emial" className="form-control" id="login-email" name="login-email" placeholder="john@example.com" aria-describedby="login-email" tabIndex="1" autoFocus />
                                    </div>
                                    ...
                                    <div className="mb-1">
                                        ...
                                        <div className="input-group input-group-merge form-password-toggle">
                                            <input type="password" onChange={(e) => setPassword(e.target.value)} className="form-control form-control-merge" id="login-password" name="login-password" tabIndex="2" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="login-password" />
